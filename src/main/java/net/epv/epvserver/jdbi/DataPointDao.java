...
public interface DataPointDao {
    ...
    @SqlUpdate("create table if not exists data_point (" +
            ...
            "weeks               int      not null," +
            "days                int      not null," +
            "mother_weight       double," +
            "mother_bp_systolic  double," +
            "mother_bp_diastolic double," +
            "primary key (id)," +
    ...
    @SqlUpdate("" +
            ...
            "    mother_weight, mother_bp_systolic, mother_bp_diastolic" +
            "  ) values (" +
            "    :id, :profileId, :timestamp, :width, :height, :thickness, :epv, :percentile, :weeks, :days," +
            "    :motherWeight, :motherBpSystolic, :motherBpDiastolic" +
            "  )")
